...
%===========================
ext_thumb.CE.F_max = 150;                 % F_max in [N] %source: Kistemaker2006, 
ext_thumb.CE.l_CEopt = 0.02;              % optimal length of CE in [m] %source: Kistemaker2006,

% serial elastic element (SEE)
% ============================
ext_thumb.SEE.l_SEE0        = 0.04;       % rest length of SEE in [m]
